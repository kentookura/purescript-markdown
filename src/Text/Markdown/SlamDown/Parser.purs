...
isSetextHeader :: forall a. String -> M.Maybe (Container a) -> Boolean
...
isTextContainer :: forall a. Container a -> Boolean
isTextContainer (CText _) = true
isTextContainer _ = false

getCText :: forall a. Container a -> String
getCText (CText s) = s
getCText _ = ""

isListItem :: forall a. SD.ListType -> Container a -> Boolean
isListItem lt1 (CListItem lt2 _) = lt1 == lt2
isListItem _ _ = false

getCListItem :: forall a. Container a -> L.List (Container a)
...
validateBlock :: forall a. SD.Block a -> V.V (Array String) (SD.Block a)
validateBlock =
  case _ of
...
validateSlamDown :: forall a. SD.SlamDownP a -> V.V (Array String) (SD.SlamDownP a)
...
parseMd :: forall a. (SD.Value a) => String -> Either String (SD.SlamDownP a)
