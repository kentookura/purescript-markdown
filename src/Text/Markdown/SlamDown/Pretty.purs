...
prettyPrintMd :: forall a. (SD.Value a) => SD.SlamDownP a -> String
...
prettyPrintBlock :: forall a. (SD.Value a) => SD.Block a -> L.List String
prettyPrintBlock bl =
  case bl of
...
prettyPrintInlines :: forall a. (SD.Value a) => L.List (SD.Inline a) -> String
prettyPrintInlines is = S.joinWith "" $ A.fromFoldable $ (map prettyPrintInline is)

prettyPrintInline :: forall a. (SD.Value a) => SD.Inline a -> String
...
prettyPrintTextBox t =
  ...
  where
  prettyPrintTemplate :: forall f. SD.TextBox f -> String
  prettyPrintTemplate =
    case _ of
